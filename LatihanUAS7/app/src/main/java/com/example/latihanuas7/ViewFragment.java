...
public class ViewFragment extends Fragment implements ItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvAdapter = new RecyclerViewAdapter(dosenList, requireContext());
    ...
    public void onClicked(View view, int position) {
        ...
        b.putInt("age", d.getAge());

        Fragment detailFragment = new DetailFragment();

        detailFragment.setArguments(b);

        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.viewDataContainer, detailFragment).commit();
